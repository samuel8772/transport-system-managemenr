...
Revision ID: 760e5cdad097
Revises: 
Create Date: 2025-07-01 22:46:20.501023
...
def upgrade():
    ...
    sa.Column('sacco_name', sa.String(length=100), nullable=False),
    sa.Column('driver_name', sa.String(length=100), nullable=False),
    sa.Column('conductor_name', sa.String(length=100), nullable=False),
    ...
    sa.Column('fare_paid', sa.Float(), nullable=False),
